...
<img src="imgaes/termux_menu.png" width="300" alt="Termux tab menu">
...
- **Tab 1**: `moltis` — Run the gateway

<img src="imgaes/termux_tab_1.png" width="300" alt="Tab 1 - moltis">

- **Tab 2**: `sshd` — Allow SSH access from your computer

<img src="imgaes/termux_tab_2.png" width="300" alt="Tab 2 - sshd">
